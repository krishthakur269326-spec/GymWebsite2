  ...
  return (
    <section className="bg-[#101010] relative min-h-[80vh] overflow-hidden px-6 md:px-8 lg:px-30 py-16 border border-b-white/5  flex flex-col justify-center items-center">
      ...
      <motion.div
        ...
        className="relative flex flex-col text-center items-center justify-between">
        <p className="mb-4 tracking-[0.35em] uppercase text-[#20A7DB] text-[0.7rem] md:text-[0.9rem] lg:text-[1.1rem]"
        >
          Begin The Journey
        </p>
        <h2 className="font-display text-white font-black text-4xl md:text-5xl leading-[1.05] text-glow"
        >
