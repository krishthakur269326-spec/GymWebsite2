...
const CertifiedTrainer = () => {
    return (
        <section className="min-h-screen bg-[#0a0a0a] text-[#fafafa] overflow-hidden pb-20">
            <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.2 }}
                viewport={{ once: true, margin: "-80px" }}
                className="max-w-6xl mx-auto px-6 pt-20 grid md:grid-cols-[1fr_auto] items-end gap-8 mb-16">
                <div>
                    <div className="mb-4 tracking-[0.35em] uppercase text-[#20A7DB] text-[0.7rem] md:text-[0.9rem] lg:text-[1.1rem]">Our Experts</div>
                    <h2 className="font-display text-white font-black text-4xl md:text-6xl leading-none">Certified Professional.<br /> Proven Results. <br /> Your transformation starts here</h2>
                </div>
                <div>
            ...
            <div className="max-w-6xl mx-auto px-6 mt-16">
                <div className="relative max-w-sm mx-auto md:max-w-none md:flex md:items-center md:gap-16">
                    ...
                    <div className="relative w-full md:w-1/2 aspect-3/4 md:aspect-square rounded-[2rem] overflow-visible">
                        <img
                            src={trainer1}
                            alt="Trainer"
                        ...
                        {/* The Rotating Badge */}
                        <div className="absolute -bottom-10 -right-10 md:-top-16 md:-left-16 w-40 h-40 md:w-48 md:h-48 z-10 bg-[#0a0a0a] rounded-full p-2 flex items-center justify-center">
                            {/* Text Rotation */}
                            <motion.div
                                animate={{ rotate: 360 }}
                    ...
                    <div className="w-full md:w-1/2 mt-16 md:mt-0 space-y-6">
                        ...
                        <h3 className="font-display text-4xl md:text-5xl font-black">Chris Bumstead</h3>
